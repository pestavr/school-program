...
INSERT INTO "new_Schedule" ("createdAt", "dayOfWeek", "endTime", "id", "locationId", "startTime", "substituteTeacherId", "teacherId", "updatedAt") SELECT "createdAt", "dayOfWeek", "endTime", "id", "locationId", "startTime", "substituteTeacherId", "teacherId", "updatedAt" FROM "Schedule";
DROP TABLE "Schedule";
